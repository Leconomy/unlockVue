...
function lifecycleMixin (Vue) {
  Vue.prototype._update = function (vnode, hydrating) {
	...
	activeInstance = vm;
	debugger;
	testFunction2ConsleObject(vm, 'L2654');
    vm._vnode = vnode;
	...
	testFunction2ConsleObject(vm, 'L2665');
...
function initMixin (Vue) {
  Vue.prototype._init = function (options) {debugger;
    var vm = this;
    // a uid
    vm._uid = uid$3++;
